...
```bash
  git clone https://github.com/developer-diganta/unified-interface-for-databases
```
...
In another terminal, go to unified databases
...
Now you can integrate and manage all your Databases!
...
To clone the repo to your local machine, run the following command in your terminal:
    ...
    ```bash
    git clone https://github.com/<your-github-username>/unified-interface-for-databases
    ```
...
To add a remote upstream, run the following command in your terminal:
    ...
    ```bash
    git remote add upstream https://github/devloper-diganta/unified-interface-for-databases
    ```
